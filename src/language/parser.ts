...
class Parser {
   ...
   */
  expectOptionalToken(kind: TokenKindEnum): Token | undefined | null {
    const token = this._lexer.token;
    if (token.kind === kind) {
      this._lexer.advance();
      return token;
   ...
   * is encountered.
   */
  unexpected(atToken?: Token | undefined | null): GraphQLError {
...
function Loc(this: any, startToken: Token, endToken: Token, source: Source) {
...
defineToJSON(Loc, function(this: any) {
