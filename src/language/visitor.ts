...
type ObjMap<T extends object, F extends (...args: any) => any> = {
...
export type Visitor<KindToNode extends object, Nodes = any> =
  | EnterLeave<
      | VisitFn<Nodes>
      | ShapeMap<
          KindToNode,
          <Node extends Nodes>(x0: Node) => VisitFn<Nodes, Node>
        >
    >
  | ShapeMap<
      KindToNode,
...
type ShapeMap<O extends object, F extends (...args: any) => any> = Partial<
  ObjMap<O, F>
>;
 ...
 */
export type VisitFn<TAnyNode, TVisitedNode extends TAnyNode = any> = (
  node: TVisitedNode,
 ...
 */
export type VisitorKeyMap<KindToNode extends object> = ObjMap<
  KindToNode,
  <T>(x0: T) => ReadonlyArray<keyof T>
>;
