 ...
 */
function join(maybeArray: any[], separator?: string | undefined) {
 ...
 */
function wrap(start: string, maybeString: string, end?: string | undefined) {
...
function hasMultilineItems(maybeArray: string[]) {
