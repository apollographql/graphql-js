...
export const __Type = new GraphQLObjectType({
  ...
  fields: () =>
    ({
      ...
      name: {
        type: GraphQLString,
        resolve: (obj: any) => (obj.name !== undefined ? obj.name : undefined),
      },
      description: {
        type: GraphQLString,
        resolve: (obj: any) =>
      ...
      ofType: {
        type: __Type,
        resolve: (obj: any) =>
          obj.ofType !== undefined ? obj.ofType : undefined,
      },
...
export function isIntrospectionType(type: unknown): boolean {
  return (
    isNamedType(type) &&
