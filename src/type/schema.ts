...
export class GraphQLSchema {
  astNode: SchemaDefinitionNode | null | undefined;
  extensionASTNodes: ReadonlyArray<SchemaExtensionNode> | null | undefined;
  _queryType: GraphQLObjectType | null | undefined;
  _mutationType: GraphQLObjectType | null | undefined;
  _subscriptionType: GraphQLObjectType | null | undefined;
  ...
  __validationErrors: ReadonlyArray<GraphQLError> | null | undefined;
  ...
  constructor(config: GraphQLSchemaConfig) {
    ...
    const initialTypes = ([
      ...
      __Schema,
    ] as Array<GraphQLNamedType | null | undefined>).concat(config.types);
  ...
  getType(name: string): GraphQLNamedType | null | undefined {
  ...
  getDirective(name: string): GraphQLDirective | null | undefined {
...
export type GraphQLSchemaValidationOptions = {
   ...
   */
  allowedLegacyNames?: ReadonlyArray<string> | null | undefined;
};
...
export type GraphQLSchemaConfig = GraphQLSchemaValidationOptions & {
  ...
  types?: Array<GraphQLNamedType> | null;
