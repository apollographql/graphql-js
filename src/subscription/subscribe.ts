 ...
 */
export function subscribe( args: SubscriptionArgs ): Promise<AsyncIterator<ExecutionResult> | ExecutionResult>;
...
function subscribeImpl(
  ...
  return sourcePromise.then(resultOrStream =>
    ...
    isAsyncIterable(resultOrStream)
      ? mapAsyncIterator(
          ((resultOrStream: any): AsyncIterable<unknown>),
          mapSourceToResponse,
          reportGraphQLError,
        )
  ...
  try {
    ...
    return Promise.resolve(result).then(eventStream => {
      ...
      if (isAsyncIterable(eventStream)) {
        ...
        return ((eventStream: any): AsyncIterable<unknown>);
      }
      throw new Error(
